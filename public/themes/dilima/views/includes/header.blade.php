                    ...
                    <div class="social-and-menu">
                        ...
                        <div class="top-social">
                            <p>
                                ...
                                <a href="www.vimeo.com/%c3%a2%c2%80%c2%8e.html"><i class="fa fa-vimeo-square"></i></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-3 col-md-3">
                    <div class="logo">
                        <a href="index-2.html"><img src="{{theme('img/logo.png')}}" alt=""></a>
                    </div>
                </div>
                                ...
                                <div class="add-to-cart-product">
                                    <div class="cart-product product-item11">
                                        <div class="cart-product-image">
                                            <a href="single-product.html"><img src="{{theme('img/cart/faded-short-sleeves-tshirt.jpg')}}" alt="Product"></a>
                                        </div>
                                    ...
                                    <div class="cart-product">
                                        <div class="cart-product-image">
                                            <a href="single-product.html"><img src="{{theme('img/cart/printed-dress.jpg')}}" alt="Product"></a>
                                        </div>
                                        <div class="cart-product-info">
                                    ...
                                    <div class="cart-product">
                                        <div class="cart-product-image">
                                            <a href="single-product.html"><img src="{{theme('img/cart/printed-summer-dress.jpg')}}" alt="Product"></a>
                                        </div>
                                        <div class="cart-product-info">
            ...
            <div class="row">
                <div class="col-sm-12 np">
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="nav">
                                <li><a class="home" href="index-2.html">Home</a>
                                    <ul>
                                        <li><a href="index-3.html"><span>Home2</span></a></li>
                                        <li><a href="index-4.html"><span>Home3</span></a></li>
                                        <li><a href="index-5.html"><span>Home4</span></a></li>
                                    </ul>
                                </li>
