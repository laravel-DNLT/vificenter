                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-cubes"></i> Wine Category <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/admin/cate">List</a></li>
                                    <li><a href="/admin/cate/create">Add</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-qrcode"></i> Wine Product <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
