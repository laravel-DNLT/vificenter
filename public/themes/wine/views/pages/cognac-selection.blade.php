...
@section('title', 'Cognac - Selection')
@section('content')
	<div id="breadcrumb" class="clearfix">
		<div class="container">
			...
			<div class="breadcrumb clearfix">
				...
				<span class="navigation-pipe" >&gt;</span>
				<span class="navigation_page">Selection</span>
			</div>
			<!-- /Breadcrumb -->
		</div>
	</div>
					...
					<div id="categories_block_left" class="block nopadding">
						...
						<div class="block_content">
							<ul class="list-block bullet tree dhtml">
								...
								<li >
									<a href="{{ url('cognac') }}" class="selected" title="Cognac">
										Cognac
								...
								{{--<div class="product-container product-block" itemscope itemtype="http://schema.org/Product">--}}
									{{--<div class="left-block">--}}
										{{--<div class="product-image-container image">--}}
											...
											{{--<a class="product_img_link"	href="{{ url('cognac/tour-eiffel') }}" title="Morbi ullamcorper" itemprop="url">--}}
											...
											{{--</a>--}}
											{{--<a class="quick-view btn-outline btn" href="{{ url('cognac/tour-eiffel') }}" rel="http://demo4leotheme.com/prestashop/leo_wine_store/en/home/12-donec-tellus-purus.html" title="Quick view" >--}}
											{{--</a>--}}
										{{--<span class="new-box">--}}
					{{--<span class="new-label product-label">New</span>--}}
				{{--</span>--}}
									...
									{{--<div class="right-block">--}}
										{{--<div class="product-meta">--}}
											{{--<h5 itemprop="name" class="name">--}}
												{{--<a class="product-name" href="{{ url('cognac/tour-eiffel') }}" title="Morbi ullamcorper" itemprop="url" >--}}
													{{--VSOP--}}
												{{--</a>--}}
											{{--</h5>--}}
											{{--<p class="product-desc" itemprop="description">--}}
