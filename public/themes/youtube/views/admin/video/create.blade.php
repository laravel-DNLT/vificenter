                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="them">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"  class="form-control col-md-12 col-xs-12" name="url">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="MoTa" class="control-label col-md-2 col-sm-2 col-xs-12">Mô Tả</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea name="description" id="" cols="30" rows="5" class="form-control col-md-12 col-xs-12"></textarea>
                                </div>
                            </div>
