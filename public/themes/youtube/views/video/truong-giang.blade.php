...
@section('title','Hài Trường Giang')
@section('content')
        ...
        <div class="large-12 columns">
            <nav aria-label="You are here:" role="navigation">
                <ul class="breadcrumbs">
                    ...
                    <li>
                        <span class="show-for-sr">Current: </span> Hài Trường Giang
                    </li>
                </ul>
            </nav>
        </div>
                                    ...
                                    <div class="item large-4 medium-6 columns grid-medium">
                                        <div class="post thumb-border">
                                            <div class="post-thumb">
                                                ...
                                                <a href="https://www.youtube.com/watch?v=nrQnnbsSC5Al" class="hover-posts">
                                                    <span><i class="fa fa-play"></i>Watch Video</span>
                                                </a>
                                            ...
                                            <div class="post-des">
                                                <h6><a href="https://www.youtube.com/watch?v=nrQnnbsSC5A">Hài kịch Thần Chém, Thần Gió </a></h6>
