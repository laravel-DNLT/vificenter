...
<header class="site-header">
    <div class="container-fluid">
        <a href="#" class="site-logo">
            <img class="hidden-md-down" src="{{admin('img/logo-2.png')}}" alt="">
            <img class="hidden-lg-up" src="{{admin('img/logo-2-mob.png')}}" alt="">
        </a>
                ...
                <div class="site-header-shown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif" aria-labelledby="dd-notification">
                            ...
                            <div class="dropdown-menu-notif-list">
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{admin('img/photo-64-1.jpg')}}" alt="">
                                    </div>
                                    <div class="dot"></div>
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{admin('img/photo-64-2.jpg')}}" alt="">
                                    </div>
                                    <div class="dot"></div>
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{admin('img/photo-64-3.jpg')}}" alt="">
                                    </div>
                                    <div class="dot"></div>
                                ...
                                <div class="dropdown-menu-notif-item">
                                    <div class="photo">
                                        <img src="{{admin('img/photo-64-4.jpg')}}" alt="">
                                    </div>
                                ...
                                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
                                    <div class="dropdown-menu-messages-list">
                                        <a href="#" class="mess-item">
                                            <span class="avatar-preview avatar-preview-32"><img src="{{admin('img/photo-64-2.jpg')}}" alt=""></span>
                                            <span class="mess-item-name">Tim Collins</span>
                                            <span class="mess-item-txt">Morgan was bothering about something!</span>
                                        </a>
                                        <a href="#" class="mess-item">
                                            <span class="avatar-preview avatar-preview-32"><img src="{{admin('img/avatar-2-64.png')}}" alt=""></span>
                    ...
                    <div class="dropdown user-menu">
                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{admin('img/avatar-2-64.png')}}" alt="">
                        </button>
...
<nav class="side-menu">
    <ul class="side-menu-list">
        <li class="grey with-sub">
            ...
            <ul>
                <li><a href="index-2.html"><span class="lbl">Default</span><span class="label label-custom label-pill label-danger">new</span></a></li>
...
<script type="text/javascript" src="{{admin('../../../www.gstatic.com/charts/loader.js')}}"></script>
<script>
